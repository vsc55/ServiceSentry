...
| GET | `/api/v1/dcim/orgs` | `dcim_view` | Las empresas que quien llama puede ver |
...
| POST · PUT · DELETE | `/api/v1/dcim/feeds[/<uid>]` | `dcim_edit` | Un cable: este equipo come de esta regleta. El permiso se mira en el ARMARIO |
