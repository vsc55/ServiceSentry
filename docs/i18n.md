...
Solo `pretty_name` y `labels` son habituales; el resto son opcionales. Todos se
fusionan en `label_i18n`/`__i18n__` por `discover_schemas()` (ver
[schema.md → Archivos de idioma](schema.md)).
