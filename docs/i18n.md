...
Algunos campos almacenados en `audit.json` contienen **claves i18n en lugar de texto traducido**. Esto permite que cada administrador vea el texto en su propio idioma al leer el log, independientemente del idioma activo cuando se generó el evento.
