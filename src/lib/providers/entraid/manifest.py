...
CONFIG_ACTIONS = [
    ...
    {'section': 'oidc', 'id': 'check_perms', 'order': 25,
     'label_key': 'entra_check_perms', 'tooltip_key': 'entra_check_perms_tt',
     'icon': 'bi-shield-check', 'variant': 'secondary',
     'fn': 'checkEntraSsoPermissions', 'group_label_key': 'entra_id',
     'show_when': {'field': 'client_id', 'not_empty': True}},
    ...
    {'section': 'saml2', 'id': 'check_perms', 'order': 18,
     'label_key': 'entra_check_perms', 'tooltip_key': 'entra_check_perms_tt',
     'icon': 'bi-shield-check', 'variant': 'secondary',
     'fn': 'checkEntraSsoPermissions', 'group_label_key': 'entra_id',
     'show_when': {'field': 'graph_secret', 'not_empty': True}},
