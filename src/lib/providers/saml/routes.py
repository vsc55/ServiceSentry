...
Routes registered by this file:
    ...
    GET    /auth/saml2/login     start SP-initiated SAML2 login
    POST   /auth/saml2/acs       assertion consumer: validate + session
    GET    /auth/saml2/metadata  serve SP metadata XML
"""
