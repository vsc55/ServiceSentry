...
CONFIG_FIELDS: tuple[Cfg, ...] = (
    ...
    Cfg('web_admin|dark_mode', bool, False, attr='_default_dark_mode',
        env='WA_DARK_MODE', no_rule=True),
    Cfg('web_admin|secure_cookies', bool, False, attr='_secure_cookies',
        env='WA_SECURE_COOKIES', admin_only=True, no_rule=True),
    Cfg('web_admin|remember_me_days', int, 30, attr='_REMEMBER_ME_DAYS',
        min=1, max=365, env='WA_REMEMBER_ME_DAYS', admin_only=True,
    ...
    Cfg('web_admin|audit_max_entries', int, 500, attr='_AUDIT_MAX_ENTRIES',
        min=0, max=10000, env='WA_AUDIT_MAX_ENTRIES'),
    ...
    Cfg('telegram|token', str, '', env='TELEGRAM_TOKEN', no_rule=True),
    Cfg('telegram|chat_id', str, '', env='TELEGRAM_CHAT_ID', no_rule=True),
    Cfg('telegram|group_messages', bool, False, env='TELEGRAM_GROUP_MESSAGES',
        no_rule=True),
