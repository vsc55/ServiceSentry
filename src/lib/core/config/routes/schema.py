...
from lib.web_admin.constants import HOME_PAGES, home_page_ids
...
def register(app, wa):
    ...
    def api_get_config_schema():
        ...
        # Default landing page: a select of the dashboard's top-level tabs, labelled
        # with each tab's i18n name (per supported language) — from the HOME_PAGES registry.
